...
- ~`/messagedelete`: **(ADMIN ONLY)** Disables/enables the message deletion function on malicouis messages.~ [DISABLED GLOBALY DUE TO ISSUES WITH MESSAGE DELETION... MAY BE REPAIRED IN THE FUTURE]
